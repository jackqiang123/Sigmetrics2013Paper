...
L=300;               % generator capacity 3000 kw       scale up 30 times
% yub=9;                % # of generators
Tu=3;
Td=3;
Ru=100;
...
% lifetime                              20 year
cm=11;            %   0.02*3000+3000*3000/20/365/24=113.7
co=gas/0.28;           % elec   efficiency 0.28
g=gas/0.8;        % boiler efficiency
e=1.8;           %   cogeneration heat efficiency

beta=140;        % 5 times full output operational cost ~ 5*(cm+3000*co)  co take mean                    
