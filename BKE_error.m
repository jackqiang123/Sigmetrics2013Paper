function [ cost,y,u ] = CHASE_error( a,anoise,b,bnoise,a,b,p,ps,g,e,co,cm,Lg,Ng,betag,Tu,Td,Ru,Rd,w)
...
anoise1=zeros(T+w,yub);
anoise1(1:T,1:yub)=anoise_L(1:T,1:yub);

b1=zeros(T+w,yub);
b1(1:T,1:yub)=b_Le(1:T,1:yub);

bnoise1=zeros(T+w,yub);
bnoise1(1:T,1:yub)=bnoise_Le(1:T,1:yub);
        ...
        for j=t:t+w
            if j==t
               R(1,i)=regret_online(R(1,i),a1(j,i),b1(j,i),p1(j,1),co,cm,g,e,betag,L );  
                ...
                R(1,i)=regret_online(R(1,i),anoise1(j,i),bnoise1(j,i),p1(j,1),co,cm,g,e,betag,L );  
            end
