...
for i=1:n
    ...
    % RHC
    [c_RHC,y_RHC,u_RHC,v_RHC,s_RHC] = RHC_w(a,b,p,co,cm,g,e,beta,L,yub,Tu,Td,Ru,Rd,w);
...
plot(0:2:2*(n-1),cr_OPT,'b-','LineWidth',7);
hold on
plot(0:2:2*(n-1),cr_BKE,'ro--','MarkerSize',10,'LineWidth',7);
hold on
plot(0:2:2*(n-1),cr_RHC,'k^:','MarkerSize',10,'LineWidth',7);

xlabel('w /h','FontSize',40,'FontName','Arial'); 
